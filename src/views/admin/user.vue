  ...
  <my-container v-loading="pageLoading">
    ...
    >
      ...
      <div class="drawer-footer">
        ...
        <el-button type="primary" :validate="addFormvalidate" :loading="addLoading" @click="onAddSubmit">保存</el-button>
      </div>
    </el-drawer>
    ...
    >
      ...
      <div class="drawer-footer">
        ...
        <el-button type="primary" :validate="editFormvalidate" :loading="editLoading" @click="onEditSubmit"> 保存</el-button>
      </div>
    </el-drawer>
  </my-container>
</template>
