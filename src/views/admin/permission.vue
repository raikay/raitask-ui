    ...
    >
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button type="primary" :validate="validateGroup" :loading="permissionGroup.loading" @click="onSubmitGroup"> 提交</el-button>
        </div>
      </template>
    </el-dialog>
    ...
    >
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button type="primary" :validate="validateMenu" :loading="permissionMenu.loading" @click="onSubmitMenu"> 提交</el-button>
        </div>
      </template>
    </el-dialog>
    ...
    >
      <el-form ref="apiForm" :model="permissionApi.form" label-width="100px" :rules="formRules">
        ...
        <el-form-item label="地址" prop="path">
          <el-input v-model="permissionApi.form.path" auto-complete="off" />
        </el-form-item>
        <el-form-item label="名称" prop="label">
      ...
      <template #footer>
        <div class="dialog-footer">
          ...
          <el-button type="primary" :validate="validateApi" :loading="permissionApi.loading" @click="onSubmitApi"> 提交</el-button>
        </div>
      </template>
    </el-dialog>
